...
<template>
  <div class="space-y-6">
    <header>
      <h1 class="text-2xl font-serif">Zod Traits Demo</h1>
      <p class="text-gray-500">Demonstrating automatic inference with Zod schemas.</p>
    </header>

    <div v-if="article" class="border p-6 rounded-lg shadow-sm bg-white">
    ...
    <div class="mt-8 pt-8 border-t text-xs font-mono text-gray-400">
      <h3 class="uppercase font-bold mb-2 text-[10px]">Debug Meta (Inferred)</h3>
